        ...
        <Container sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: "40px", marginTop: "64px", }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: "100px" }}>
                <Box sx={{ position: 'relative', height: "828px", width: "828px" }}>
                    <Box component='img' src='images/Ellipse 175.png' sx={{ position: 'absolute', top: "-30%", left: '-40%' }} />
                    <Box component='img' src='images/ring.png' sx={{ position: 'absolute', height: "650px", width: "650px", top: "10%", left: '-15%' }} />
                ...
                <Box >
                    <Box>
                        <Typography variant='h3' sx={{ color: theme.palette.tertiary.main }}>FEATURES</Typography>
                        <Typography variant='h1'>Crypto Premium</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', flexDirection: 'column', marginTop: '30px', gap: '20px', }}>
                        <Typography variant='h3' sx={{
                            display: 'flex', alignItems: 'center', gap: '10px'
                        }}><Box component='img' src='images/starPink.png' />Budgeting Intervals</Typography>
                        <Typography variant='p'>Lorem ipsum dolor sit amet. Qui consequatur sint 33 voluptatem officia et sint laboriosam sed ipsa sint ut voluptatum labore et.</Typography>
                        <Typography variant='h3' sx={{
                            display: 'flex', alignItems: 'center', gap: '10px'
                        }} ><Box component='img' src='images/cube1.png' />Budgeting Intervals</Typography>
                        <Typography variant='p'>Lorem ipsum dolor sit amet. Qui consequatur sint 33 voluptatem officia et sint laboriosam sed ipsa sint ut voluptatum labore et.</Typography>
                        <Typography variant='h3' sx={{
                            display: 'flex', alignItems: 'center', gap: '10px'
                        }}><Box component='img' src='images/cube2.png' />Budgeting Intervals</Typography>
                        <Typography variant='p'>Lorem ipsum dolor sit amet. Qui consequatur sint 33 voluptatem officia et sint laboriosam sed ipsa sint ut voluptatum labore et.</Typography>
