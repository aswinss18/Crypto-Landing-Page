...
const testimonials = [{ name: 'Albert Flores', job: "Founder of GearUp", image: 'images/profile1.png', play: false }, { name: 'Leslie Alexander', job: "Co-Founder of Womenia", image: 'images/profile2.png', play: true }, { name: 'Courtney Henry', job: "Founder of CH Beauty", image: 'images/profile3.png', play: false },]
    ...
    return (
        <Container maxWidth={false} sx={{ height: "884px", display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '60px' }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-evenly', width: "100%" }}>
                {testimonials.map((testimonial, i) => <TestimonialCard data={testimonial} key={i} />)}
            </Box>
