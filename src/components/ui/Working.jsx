...
export default function Working() {
    ...
    return (
        <Container sx={{ display: 'flex', marginY: "100px", justifyItems: 'center', alignItems: 'center', gap: '100px' }}>
            <Box sx={{ position: 'relative' }}>
                ...
                <Box component='img' src='images/phones.png' sx={{ height: 699, width: 531, position: 'relative', zIndex: 1 }} />
